...
/**
 * שכבת נתונים יחידה בתבנית Repository מעל LocalStorage.
 * החלפה עתידית ל-Firebase/Supabase מחייבת שינוי בקובץ הזה בלבד —
 * כל הקומפוננטות וה-hooks צורכים את אותו API.
 */
